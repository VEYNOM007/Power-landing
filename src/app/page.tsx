...
function GooglePlayIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
      <path d="M3.609 1.814L13.792 12 3.61 22.186a.996.996 0 01-.61-.92V2.734a1 1 0 01.609-.92zm10.89 10.893l2.302 2.302-10.937 6.333 8.635-8.635zm3.199-3.198l2.302 2.302-2.302 2.302-2.64-2.302 2.64-2.302zM5.864 2.658L16.8 8.99l-2.302 2.302-8.635-8.635z" />
    </svg>
  );
}
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-5 pt-20 pb-12">
      <div className="relative max-w-3xl mx-auto text-center">
        ...
        >
          {/* Google Play — Bleu Clair */}
          <a
            href={PLAY_STORE_URL}
            onClick={() => trackDownload("android")}
            className="btn-power flex items-center justify-center gap-3 w-full sm:w-auto min-h-[56px] px-8 rounded-2xl bg-[#3E92CC] text-white font-semibold text-base"
          >
            <GooglePlayIcon />
            <span className="font-bold">Rejoindre l&apos;élite des testeurs</span>
          </a>

          {/* TestFlight — Bleu Principal */}
          <a
            href={TESTFLIGHT_URL}
            onClick={() => trackDownload("ios")}
            className="btn-power flex items-center justify-center gap-3 w-full sm:w-auto min-h-[56px] px-8 rounded-2xl bg-[#0A2463] text-white font-semibold text-base"
          >
            <AppleIcon />
            <span className="font-bold">Rejoindre l&apos;élite des testeurs</span>
          </a>
